...
export class  SponsorsContainer extends Component {
    ...
    render(){
        ...
        <div className="sponsor-container">
                        ...
                        <Link to="/donate" className="sponsorshowcase-button donate-button">Donations</Link>
                        <a href={sponsorShipPackage} target='_blank' className="sponsorshowcase-button package-button">Sponsorship Package</a>
